		...
		constructor( object, domElement ) {
			...
			const pan = function () {
				...
				return function pan( deltaX, deltaY ) {
					...
					// AXC: handle combined camera
					var isCombinedCamera = THREE.CombinedCamera && scope.object instanceof THREE.CombinedCamera;

					if ( scope.object.isPerspectiveCamera || (isCombinedCamera && scope.object.inPerspectiveMode) ) {
					...
					} else if ( scope.object.isOrthographicCamera || (isCombinedCamera && !scope.object.inPerspectiveMode)) {
